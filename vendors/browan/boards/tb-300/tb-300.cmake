...
set(AFR_ESP_LWIP 1)
set(RUN_IN_IDT_MODE 0)	# { 1: IDT mode | 0: normal }

if(NOT RUN_IN_IDT_MODE)
	message("INFO >> vendors/browan/boards/tb-300/tb-300.cmake: add -DUSE_IOT_DEVICE_SKU_TB_300")
	add_definitions(-DUSE_IOT_DEVICE_SKU_TB_300)
else()
	message("INFO >> vendors/browan/boards/tb-300/tb-300.cmake: RUN_IN_IDT_MODE")
endif()
